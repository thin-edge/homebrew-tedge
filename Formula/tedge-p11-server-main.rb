...
class TedgeP11ServerMain < Formula
    ...
    on_macos do
        on_arm do
            url "https://dl.cloudsmith.io/public/thinedge/tedge-main/raw/names/tedge-p11-server-macos-arm64/versions/1.5.2-rc115+g9909b6e/tedge-p11-server.tar.gz"
            sha256 "c4911eda2bbab24386f2b7fac65a3e1e2aac6fde4935c5181c9033e68e01995a"
        end
        on_intel do
            url "https://dl.cloudsmith.io/public/thinedge/tedge-main/raw/names/tedge-p11-server-macos-amd64/versions/1.5.2-rc115+g9909b6e/tedge-p11-server.tar.gz"
            sha256 "70303bf4dc4ef043d9009e260129c7e17cfafd52a46d67c69439d874aca097c6"
        end
    end
